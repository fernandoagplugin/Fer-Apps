...
st.set_page_config(page_title="EquityDash Ultra v6.7", page_icon=LOGO_SIDEBAR, layout="wide")
...
# 2. Ativos e Parâmetros (Inteligência REIT adicionada)
acoes_config = {
    ...
    'EQIX': {'tipo': 'REIT', 'cor': '#E31C23', 'dpa': 17.04, 'ffo': 34.80, 'price': 800.00, 'logo': "https://logo.clearbit.com/equinix.com", 'moeda': 'US$'}
}
